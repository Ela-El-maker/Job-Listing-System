                ...
                <div class="row mt-30">
                                                    ...
                                                    <div class="col-lg-6 col-6">
                                                        <div class="d-flex">
                                                            <div class="info-right-img"><span
                                                                    ...
                                                                    class="font-xs color-text-paragraph-2"></span>
                                                            </div>
                                                        </div>
                                                    </div>
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 col-12 pl-40 pl-lg-15 mt-lg-30">
                        ...
                        <div class="sidebar-shadow sidebar-news-small">
                            <h5 class="sidebar-title">Featured Now</h5>
                            <div class="post-list-small">
                                ...
                                @empty
                                    <div class="post-list-small-item text-center py-4">
                                        <div class="empty-state-icon mb-3">
                                            <i class="fas fa-newspaper fa-3x text-muted"></i>
                                        </div>
                                        <h6 class="fw-bold">No Featured Stories Yet</h6>
                                        <p class="text-muted small">Our editors are curating amazing content for you. Check
                                            back soon!</p>
                                        <a href="{{ route('blogs.index') }}"
                                            class="btn btn-sm btn-outline-primary mt-2">Browse All Articles</a>
                                    </div>
                                @endforelse
