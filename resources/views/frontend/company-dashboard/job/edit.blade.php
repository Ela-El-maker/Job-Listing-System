                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group select-style">
                                                <label for="">Experience <span
                                                        class="text-danger">*</span></label>
                                                <select
                                                    class="form-control form-icons select-active {{ hasError($errors, 'experience') }} select2"
                                                    name="experience">
                                                    <option value="">Choose</option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group select-style">
                                                ...
                                                <select
                                                    class="form-control form-icons select-active {{ hasError($errors, 'job_role') }} select2"
                                                    name="job_role">
                                                    <option value="">Choose</option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group select-style">
                                                ...
                                                <select
                                                    class="form-control form-icons select-active {{ hasError($errors, 'education') }} select2"
                                                    name="education">
                                                    <option value="">Choose</option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group select-style">
                                                ...
                                                <select
                                                    class="form-control form-icons select-active {{ hasError($errors, 'job_type') }} select2"
                                                    name="job_type">
                                                    <option value="">Choose</option>
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input @checked($job?->is_featured) style="height:18px; width:18px;"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input @checked($job?->is_highlighted) style="height:18px; width:18px;"
                                                    type="checkbox" id="highlight"
