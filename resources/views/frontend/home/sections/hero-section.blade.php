                    ...
                    <div class="col-xl-8 col-lg-12">
                        <div class="block-banner">
                            ...
                            <div class="banner-description mt-20 wow animate__animated animate__fadeInUp"
                                data-wow-delay=".1s">
                                <p>{!! $hero?->sub_title ??
                                    'Search for jobs, read career advice from our experts, and find the perfect job for you.' !!}
                                </p>
                            </div>
                            <div class="form-find mt-40 wow animate__animated animate__fadeIn" data-wow-delay=".2s">
                                <form action="{{ route('jobs.index') }}" method="GET" class="form-search">
                                    @csrf
                                    ...
                                    <input class="form-input input-keysearch mr-10" name="search" type="text"
