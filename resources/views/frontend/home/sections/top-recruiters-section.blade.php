                                ...
                                <a href="{{ route('companies.show',$company?->slug) }}">
                                    <div class="item-logo">
                                        <div class="image-left">
                                            <img alt="joblist" src="{{ asset($company?->logo) }}">
                                        </div>
                                        ...
                                        <div class="text-info-bottom mt-5">
                                            <span class="font-xs color-text-muted icon-location">
                                                {{ $company?->companyCountry?->name,$company?->companyState?->name }}
                                            </span>
                                            <span class="font-xs color-text-muted float-end mt-5">
                                                {{ $company->jobs_count }}
                                                <span>
                                                    Open
                                                    Jobs
