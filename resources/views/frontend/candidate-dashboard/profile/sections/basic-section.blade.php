    ...
    <form action="{{ route('candidate.profile.basic-info.update') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="form-group">
                    <label class="font-sm color-text-mutted mb-10">CV <span class="text-primary">(
                            {{ $candidate?->cv ? 'Have Attached CV.' : '' }} )</span> </label>
                    <input class="form-control {{ $errors->has('cv') ? 'is-invalid' : '' }}" name="cv"
                        type="file" value="">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('full_name') ? 'is-invalid' : '' }}"
                                name="full_name" type="text" value="{{ $candidate?->full_name }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('website') ? 'is-invalid' : '' }}"
                                name="website" type="text" value="{{ $candidate?->website }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input
                                ...
                                name="date_of_birth" type="text" value="{{ $candidate?->birth_date }}">
