    ...
    <section class="section-box mt-120">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9 col-md-12 col-sm-12 col-12 mb-50">
                    <div class="content-single">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-6">
                                    <div class="dash_overview_item bg-info-subtle">
                                        <h2>{{ $jobApplied }} <span>jobs applied</span></h2>
                                        <span class="icon"><i class="fas fa-briefcase"></i></span>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6">
                                    <div class="dash_overview_item bg-danger-subtle">
                                        <h2>{{ $userBookmarkedJobs }} <span>Bookmarked Jobs</span></h2>
                                        <span class="icon"><i class="fas fa-briefcase"></i></span>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-12 mt-30">
                                        <div class="dash_alert_box p-30 bg-danger rounded-4 d-flex flex-wrap">
                                            ...
                                            <div class="text">
                                                ...
                                                <p>Please complete your Candidate profile to use all the features.</p>
                                            </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-50">
                            <div class="mb-3">
                                <h3 class="mb-0">Recently Applied</h3>
                            </div>
                                ...
                                <table class="table"
                                    ...
                                    <tbody>
                                        @forelse ($appliedJobs as $appliedJob)
                                            <tr
                                                style="transition: background-color 0.2s; border-bottom: 1px solid #e9ecef;">
                                                ...
                                                <td
                                                    ...
                                                    @else
                                                        <div style="font-weight: 600;">
                                                            {{ $appliedJob?->job?->custom_salary }}</div>
                                                        <span style="color: #6c757d; font-size: 13px;">
                                                            per {{ $appliedJob?->job?->salaryType?->name }}
                                                        </span>
                                                    @endif
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="5"
                                                    ...
                                                    <div style="font-size: 14px;">When you apply for jobs, they will appear
                                                        here
                                                    </div>
                                                </td>
                                            </tr>
