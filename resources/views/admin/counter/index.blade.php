        ...
        <div class="card">
            ...
            <div class="card-body ">
                <form action="{{ route('admin.counter.update', 1) }}" method="POST" enctype="multipart/form-data">
                    {{-- If you want to create a new counter, use POST method --}}
                    {{-- If you want to update an existing counter, use PUT method --}}
                    @csrf
                    @method('PUT') {{-- This is important for updating the counter --}}
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control {{ hasError($errors, 'counter_one') }}"
                                    value="{{ old('counter_one', $counter?->counter_one) }}" name="counter_one">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control {{ hasError($errors, 'title_one') }}"
                                    value="{{ old('title_one', $counter?->title_one) }}" name="title_one">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control {{ hasError($errors, 'counter_two') }}"
                                    value="{{ old('counter_two', $counter?->counter_two) }}" name="counter_two">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control {{ hasError($errors, 'title_two') }}"
                                    value="{{ old('title_two', $counter?->title_two) }}" name="title_two">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control {{ hasError($errors, 'counter_three') }}"
                                    value="{{ old('counter_three', $counter?->counter_three) }}" name="counter_three">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control {{ hasError($errors, 'title_three') }}"
                                    value="{{ old('title_three', $counter?->title_three) }}" name="title_three">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control {{ hasError($errors, 'counter_four') }}"
                                    value="{{ old('counter_four', $counter?->counter_four) }}" name="counter_four">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control {{ hasError($errors, 'title_four') }}"
                                    value="{{ old('title_four', $counter?->title_four) }}" name="title_four">
