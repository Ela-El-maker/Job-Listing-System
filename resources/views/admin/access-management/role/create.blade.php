...
@section('contents')
    ...
    <section class="section">
        <div class="section-header d-flex justify-content-between align-items-center">
            <h1><i class="fas fa-user-shield mr-2"></i>Roles and Permissions</h1>
                ...
                <div class="col-12">
                    <div class="card shadow-sm">
                        <div class="card-header bg-white">
                            <h4 class="card-title"><i class="fas fa-plus-circle mr-2"></i>Create New Role</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('admin.role.store') }}" method="post">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="role-name"
                                            ...
                                            placeholder="Enter role name" value="{{ old('name') }}" name="name">
                                    </div>
                                ...
                                <div class="permissions-container">
                                    <div class="permissions-header d-flex justify-content-between align-items-center mb-3">
                                        <h5 class="text-primary mb-0"><i class="fas fa-lock mr-2"></i>Assign Permissions
                                        </h5>
                                        <div>
                                            ...
                                            <div class="card mb-3 border">
                                                <div class="card-header bg-light" id="heading{{ Str::slug($groupName) }}">
                                                    <div class="d-flex justify-content-between align-items-center permission-group-header"
                                                        ...
                                                        <button type="button"
                                                            class="btn btn-sm btn-outline-dark group-selector">
                                                                    ...
                                                                    <div class="permission-item p-2 rounded">
                                                                        <div class="custom-control custom-switch">
                                                                            ...
                                                                            <label
                                                                                ...
                                                                                <span
                                                                                    class="text-dark permission-label">{{ $item->name }}</span>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                                </div>
