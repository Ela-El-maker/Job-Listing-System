...
@section('contents')
    ...
    <section class="section">
        <div class="section-header d-flex justify-content-between align-items-center">
            <h1><i class="fas fa-user-shield mr-2"></i>User Role Assignment</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0">
                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Create User with Role</li>
                </ol>
            </nav>
        </div>
                ...
                <div class="col-12">
                    <div class="card shadow-sm">
                        <div class="card-header bg-white">
                            <h4 class="card-title"><i class="fas fa-user-plus mr-2"></i>Create New User with Role</h4>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group" style="position: relative;">
                                        ...
                                        <select id="role-name" class="form-control {{ hasError($errors, 'role') }}"
                                            name="role" style="position: relative; z-index: 1;">
