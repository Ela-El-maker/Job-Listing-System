            ...
            <div class="row">
                <div class="col-lg-5 col-md-6 col-sm-12 mx-auto">
                    <div class="login-register-cover">
                        ...
                        <form method="POST" class="login-register text-start mt-20" action="{{ route('password.email') }}">
                            @csrf


                            <!-- Email Address -->
                            <div class="form-group">
                                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" id="input-1" type="email" required="" name="email" placeholder="example@example.com"
                                    value="{{ old('email') }}">
