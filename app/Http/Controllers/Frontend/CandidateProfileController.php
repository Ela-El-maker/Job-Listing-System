...
class CandidateProfileController extends Controller
{
    ...
    function index(): View
    {
        ...
        return view('frontend.candidate-dashboard.profile.index', compact('candidate','candidateExperiences','candidateEducations','experiences','skills','languages','professions'));
    }
